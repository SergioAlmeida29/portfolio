...
export function Hero() {
  ...
  return (
    <section className="mx-auto grid min-h-[100dvh] max-w-6xl content-center gap-14 px-6 pt-28 pb-20 md:px-10 lg:grid-cols-12 lg:gap-10 xl:max-w-7xl">
      ...
      <div className="lg:col-span-5 lg:self-center xl:col-span-4 xl:col-start-9">
        <NowPanel />
      </div>
    </section>
  )
